...
*******************************************************************/
int string_to_int(string num, int& value){
	value = 0;
	unsigned int sign = 1;
    for (int i=0; i < num.length(); i++)
    {
...
/*******************************************************************
** Function: gcd
** Description: determines greatest common divisor of two integers
** Parameters: two integers (num1 and num2)
** Pre-conditions: takes two integers num1 and num2
** Post-conditions: return gcd of both numbers
*******************************************************************/
...
bool to_lowest_terms(int &numerator, int &denominator)
{
	...
	if(denominator == 0)
	{
		...
		cout << "Invalid Input. Denominator must be integer that isn't 0." << endl;
		return false;

	}
	// if den works then gcd and simplify
