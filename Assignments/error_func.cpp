...
** Date: 05/01/2022
** Description: Checks if functions work
** Input: Given function checks
** Output: Whether or not the function worked
*******************************************************************/
#include <iostream>
#include <string>
#include <cstdlib>
...
/*******************************************************************
** Function: pause()
** Description: Creates lag between input and next ouput in the terminal
** Parameters: n/a
** Pre-conditions: must respond to press anything to continue (press something)
** Post-conditions: waits for a little then continues on with the program
*******************************************************************/
void pause(){
